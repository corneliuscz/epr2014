        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse-main">
            ...
            <div class="row menu">
              ...
              <div class="col-sm-2 menu-item"><a href="#program">Program</a></div>
              <div class="col-sm-2 menu-item menu-item--program"><a href="#prezentace">Prezentace</a></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4 col-md-3 col-md-offset-2 col-lg-offset-3">
            <a href="#prezentace" class="btn btn-primary btn-lg btn-block btn-registrace" role="button">Prezentace</a>
          </div>
        </div>
      </div>
    </div>
